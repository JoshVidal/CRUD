 ...
 <table>
        ...
        <tbody>
            <?php while ($fila = $resultado->fetch_assoc()) { ?>
              ...
              <div class="dropdown">          
             <button class="actions-btn edit" onclick="toggleEditForm(<?php echo $fila['id']; ?>)">Editar</button>
              <div class="dropdown-content hidden"> <!-- Agrega la clase "hidden" aquí -->
                        <form id="edit-form-<?php echo $fila['id']; ?>" class="edit-form" method="post" action="editar_usuario.php">
                            <input type="hidden" name="id_usuario" value="<?php echo $fila['id']; ?>">
